...
function setCookie(name, value, bPersistent)
{
	var expires = ";";
	if(bPersistent) {
		// EDIT: Changed expiration string (didn't work in IE11)
        var d = new Date();
        d.setTime(d.getTime() + (20 * 365 * 24 * 60 * 60 * 1000)); // Today + 20 years      
        expires = ";expires="+d.toUTCString();
    }
	// EDIT: Added check for empty string (IE11 returns "")
    if(gHost!=null && gHostPath!=null && gHost!="" && gHostPath!="")
